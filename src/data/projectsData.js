import { faReact, faNodeJs, faJsSquare, faHtml5, faSass, faMdb, faCss3Alt, faBootstrap } from '@fortawesome/free-brands-svg-icons';
...
const projectsData = [
    {
        ...
        imageUrl: 'https://res.cloudinary.com/dizd9f3ky/image/upload/v1706703680/LuckyMockUp2_s60wsy.jpg',
    ...
    },
    {
        ...
        techIcons: [faJsSquare, faNodeJs, faHtml5, faSass, faMdb]
    },
    {
        ...
        techIcons: [faHtml5, faCss3Alt, faSass, faBootstrap]
    },
    {
